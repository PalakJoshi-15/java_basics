public class DataTypes {
	...
	public boolean equals(DataTypes otherType) {
		if ((this.intVar == otherType.intVar) && 
		(this.doubleVar == otherType.doubleVar) && 
		(this.charVar == otherType.charVar) && 
		(this.boolVar == otherType.boolVar) &&
		//(this.varA.equals(otherType.varA))) {
		(this.varA == otherType.varA)) {
			return true;
		}
		else {
			return false;
